...
| **11** | **Xử Lý 101 Logic Conflicts & Corner Cases Toàn Hệ Thống (`LC-01` ➔ `LC-101`)** | Triệt tiêu 100% các xung đột logic nghiệp vụ: chỉ định Quản lý dự án khi khởi tạo & tự động cấp quyền Manager cho nhân viên, chặn tuyệt đối trùng tên dự án (case-insensitive), tự động khôi phục Dự án cha khi khôi phục Task mồ côi, auto-purge thùng rác 14 ngày, hạ cờ URGENT động, an toàn mở task từ thông báo, bảo vệ Idempotency chống Race Condition, phân trang và dọn dẹp thông báo 30 ngày, phòng thủ thời gian âm. | **100%** | ✅ Pass |
